# HW2
* 八皇后
    * 如何能夠在8×8的西洋棋棋盤上放置八個皇后，讓任何一個皇后都無法直接吃掉其他的皇后
    * 任兩個皇后都不能處於同一條橫行、縱行或斜線上
# code
* [queen](https://github.com/www-abcdefg/ai109b/blob/main/homework/queen.py)
```
def queen(n): # 主函數
...
```
* 執行結果
    * [1, 3, 0, 2] [2, 0, 3, 1] 為四皇后的執行結果
```
PS C:\Users\柯泓吉\Desktop\課程\人工智慧\ai109b\homework> python queen.py
[1, 3, 0, 2]
[2, 0, 3, 1]
[0, 4, 7, 5, 2, 6, 1, 3]
[0, 5, 7, 2, 6, 3, 1, 4]
